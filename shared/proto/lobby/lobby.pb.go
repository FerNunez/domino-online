...
func (x *CreateLobbyRequest) GetDisplayName() string {
	if x != nil {
...
func (x *JoinLobbyRequest) GetDisplayName() string {
	if x != nil {
		return x.DisplayName
	}
	return ""
...
type ReconnectLobbyRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID,omitempty"`
	LobbyID       string                 `protobuf:"bytes,2,opt,name=lobbyID,proto3" json:"lobbyID,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ReconnectLobbyRequest) Reset() {
	*x = ReconnectLobbyRequest{}
	mi := &file_lobby_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReconnectLobbyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReconnectLobbyRequest) ProtoMessage() {}

func (x *ReconnectLobbyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_lobby_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReconnectLobbyRequest.ProtoReflect.Descriptor instead.
func (*ReconnectLobbyRequest) Descriptor() ([]byte, []int) {
	return file_lobby_proto_rawDescGZIP(), []int{4}
}

func (x *ReconnectLobbyRequest) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *ReconnectLobbyRequest) GetLobbyID() string {
	if x != nil {
		return x.LobbyID
	}
	return ""
...
type ReconnectLobbyResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Lobby         *Lobby                 `protobuf:"bytes,1,opt,name=lobby,proto3" json:"lobby,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ReconnectLobbyResponse) Reset() {
	*x = ReconnectLobbyResponse{}
	mi := &file_lobby_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReconnectLobbyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReconnectLobbyResponse) ProtoMessage() {}

func (x *ReconnectLobbyResponse) ProtoReflect() protoreflect.Message {
	mi := &file_lobby_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReconnectLobbyResponse.ProtoReflect.Descriptor instead.
func (*ReconnectLobbyResponse) Descriptor() ([]byte, []int) {
	return file_lobby_proto_rawDescGZIP(), []int{5}
}

func (x *ReconnectLobbyResponse) GetLobby() *Lobby {
	if x != nil {
		return x.Lobby
	}
	return nil
...
const file_lobby_proto_rawDesc = "" +
	...
	"secretCode\x12 \n" +
	"\vdisplayName\x18\x04 \x01(\tR\vdisplayName\"7\n" +
	"\x11JoinLobbyResponse\x12\"\n" +
	"\x05lobby\x18\x01 \x01(\v2\f.lobby.LobbyR\x05lobby\"I\n" +
	"\x15ReconnectLobbyRequest\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x18\n" +
	"\alobbyID\x18\x02 \x01(\tR\alobbyID\"<\n" +
	"\x16ReconnectLobbyResponse\x12\"\n" +
	...
	"\x12StartLobbyResponse\"+\n" +
	"\x0fGetLobbyRequest\x12\x18\n" +
	"\alobbyID\x18\x01 \x01(\tR\alobbyID\"6\n" +
	"\x10GetLobbyResponse\x12\"\n" +
	"\x05lobby\x18\x01 \x01(\v2\f.lobby.LobbyR\x05lobby\"\xd6\x01\n" +
	"\x05Lobby\x12\x0e\n" +
	...
	"\bsettings\x18\x06 \x01(\v2\x14.lobby.LobbySettingsR\bsettings\"b\n" +
	"\x06Player\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04slot\x18\x03 \x01(\x05R\x04slot\x12 \n" +
	"\visConnected\x18\x04 \x01(\bR\visConnected\"W\n" +
	...
	"\x15LOBBY_STATUS_FINISHED\x10\x022\xe3\x02\n" +
	"\fLobbyService\x12D\n" +
	"\vCreateLobby\x12\x19.lobby.CreateLobbyRequest\x1a\x1a.lobby.CreateLobbyResponse\x12>\n" +
	"\tJoinLobby\x12\x17.lobby.JoinLobbyRequest\x1a\x18.lobby.JoinLobbyResponse\x12M\n" +
	"\x0eReconnectLobby\x12\x1c.lobby.ReconnectLobbyRequest\x1a\x1d.lobby.ReconnectLobbyResponse\x12A\n" +
	"\n" +
	"StartLobby\x12\x18.lobby.StartLobbyRequest\x1a\x19.lobby.StartLobbyResponse\x12;\n" +
	"\bGetLobby\x12\x16.lobby.GetLobbyRequest\x1a\x17.lobby.GetLobbyResponseB\x1aZ\x18shared/proto/lobby;lobbyb\x06proto3"
...
var file_lobby_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_lobby_proto_goTypes = []any{
	...
	(*ReconnectLobbyRequest)(nil),  // 5: lobby.ReconnectLobbyRequest
	(*ReconnectLobbyResponse)(nil), // 6: lobby.ReconnectLobbyResponse
	(*StartLobbyRequest)(nil),      // 7: lobby.StartLobbyRequest
	(*StartLobbyResponse)(nil),     // 8: lobby.StartLobbyResponse
	(*GetLobbyRequest)(nil),        // 9: lobby.GetLobbyRequest
	(*GetLobbyResponse)(nil),       // 10: lobby.GetLobbyResponse
	(*Lobby)(nil),                  // 11: lobby.Lobby
	(*Player)(nil),                 // 12: lobby.Player
	(*LobbySettings)(nil),          // 13: lobby.LobbySettings
}
var file_lobby_proto_depIdxs = []int32{
	11, // 0: lobby.CreateLobbyResponse.lobby:type_name -> lobby.Lobby
	11, // 1: lobby.JoinLobbyResponse.lobby:type_name -> lobby.Lobby
	11, // 2: lobby.ReconnectLobbyResponse.lobby:type_name -> lobby.Lobby
	11, // 3: lobby.GetLobbyResponse.lobby:type_name -> lobby.Lobby
	12, // 4: lobby.Lobby.players:type_name -> lobby.Player
	0,  // 5: lobby.Lobby.status:type_name -> lobby.LobbyStatus
	13, // 6: lobby.Lobby.settings:type_name -> lobby.LobbySettings
	1,  // 7: lobby.LobbyService.CreateLobby:input_type -> lobby.CreateLobbyRequest
	3,  // 8: lobby.LobbyService.JoinLobby:input_type -> lobby.JoinLobbyRequest
	5,  // 9: lobby.LobbyService.ReconnectLobby:input_type -> lobby.ReconnectLobbyRequest
	7,  // 10: lobby.LobbyService.StartLobby:input_type -> lobby.StartLobbyRequest
	9,  // 11: lobby.LobbyService.GetLobby:input_type -> lobby.GetLobbyRequest
	2,  // 12: lobby.LobbyService.CreateLobby:output_type -> lobby.CreateLobbyResponse
	4,  // 13: lobby.LobbyService.JoinLobby:output_type -> lobby.JoinLobbyResponse
	6,  // 14: lobby.LobbyService.ReconnectLobby:output_type -> lobby.ReconnectLobbyResponse
	8,  // 15: lobby.LobbyService.StartLobby:output_type -> lobby.StartLobbyResponse
	10, // 16: lobby.LobbyService.GetLobby:output_type -> lobby.GetLobbyResponse
