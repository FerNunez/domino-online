...
const (
	...
	LobbyService_ReconnectLobby_FullMethodName = "/lobby.LobbyService/ReconnectLobby"
...
type LobbyServiceClient interface {
	...
	ReconnectLobby(ctx context.Context, in *ReconnectLobbyRequest, opts ...grpc.CallOption) (*ReconnectLobbyResponse, error)
...
func (c *lobbyServiceClient) ReconnectLobby(ctx context.Context, in *ReconnectLobbyRequest, opts ...grpc.CallOption) (*ReconnectLobbyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReconnectLobbyResponse)
	err := c.cc.Invoke(ctx, LobbyService_ReconnectLobby_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LobbyServiceServer interface {
	...
	ReconnectLobby(context.Context, *ReconnectLobbyRequest) (*ReconnectLobbyResponse, error)
...
func (UnimplementedLobbyServiceServer) ReconnectLobby(context.Context, *ReconnectLobbyRequest) (*ReconnectLobbyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReconnectLobby not implemented")
}
...
func _LobbyService_ReconnectLobby_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReconnectLobbyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LobbyServiceServer).ReconnectLobby(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LobbyService_ReconnectLobby_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LobbyServiceServer).ReconnectLobby(ctx, req.(*ReconnectLobbyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LobbyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReconnectLobby",
			Handler:    _LobbyService_ReconnectLobby_Handler,
		},
		{
